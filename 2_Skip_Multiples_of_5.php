...
<body>
    <?php
    function skipMultipleofFive($start,$end){
        for($i=$start;$i<=$end;$i++){
            if($i % 5 ==0){
                continue;
            }
    ...
    <center>
        ...
        <a href="http://localhost/Ostad-Module-2-main/Ostad-Module-2-main/2_Skip_Multiples_of_5.php"
            style="text-decoration:none;cursor: pointer;">
            <h2 class=" IncreamentFunction-top">Skip Multiples of 5</h2>
        </a><br>
    </center>
            ...
            <tr>
                <th colspan="2">
                    <button
                        ...
                        title="Click to generate loop values">Generate Loop Values</button>
    ...
    <table border="0" align="center">
        ...
        <tr>
            <th colspan="2"> <a
                    href="http://localhost/Ostad-Module-2-main/Ostad-Module-2-main/2_Skip_Multiples_of_5.php"
                    style="text-decoration:none;cursor: pointer;">
    ...
    /**Skip Multiple of 5 function runs using for loop with the provided data if there is no errors */

    skipMultipleofFive($start, $end);
    }
    ?>
    <center>
        <br>
        <h2 class="IncreamentFunction-bottom">Coded by <a href="https://mahmudrayhan.com"
                ...
                style="text-decoration:none; color:lightgreen;"> Ostad</a> Module-2 {Task - 2}</h2><br>
    </center>
</body>
